    ...
    <div className="space-y-8">
      <div className="flex flex-col gap-4 rounded-[32px] border border-white/10 bg-glass p-7 shadow-card backdrop-blur-xl md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <span className="rounded-3xl bg-white dark:bg-slate-900/80 px-4 py-3 text-sm text-slate-900 dark:text-slate-300">{activeCount} active projects</span>
      ...
      <div className="rounded-[32px] border border-white/10 bg-glass p-6 shadow-card backdrop-blur-xl">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="inline-flex items-center gap-2 rounded-3xl bg-white dark:bg-slate-900/80 px-4 py-3 text-sm text-slate-900 dark:text-slate-300">
            <Layers className="h-4 w-4" /> Live sync
          </div>
        </div>
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          <div className="rounded-[28px] bg-white dark:bg-slate-950/80 p-5">
            <p className="text-sm text-slate-400">Upcoming feature deliveries</p>
            <p className="mt-4 text-3xl font-semibold text-slate-900 dark:text-slate-100">7 launches</p>
          </div>
          <div className="rounded-[28px] bg-white dark:bg-slate-950/80 p-5">
            <p className="text-sm text-slate-400">Resource efficiency score</p>
            <p className="mt-4 text-3xl font-semibold text-slate-900 dark:text-slate-100">94%</p>
          </div>
        </div>
      </div>
