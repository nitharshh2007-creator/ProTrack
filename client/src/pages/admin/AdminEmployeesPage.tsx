...
import { Mail, Search as SearchIcon, UserCircle2, Trash2, Clock, Filter } from "lucide-react";
...
import type { User, InviteRecord, Project } from "@/types";
...
export const AdminEmployeesPage = () => {
  ...
  const filteredMembers = useMemo(
    ...
    [members, projectMembers, selectedProjectId, search]
  );
  ...
  return (
    <div className="space-y-8">
      ...
      {/* ── Project Filter ── */}
      <div className="rounded-2xl bg-white shadow-sm overflow-hidden p-6">
        <div className="flex items-center gap-3">
          <Filter className="h-5 w-5 text-gray-600" />
          <label className="text-sm font-semibold text-gray-700">Filter by Project:</label>
          <select
      ...
      <div className="rounded-2xl bg-white shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-100">
          <h2 className="text-base font-semibold text-gray-800">
            {selectedProjectId ? "Project Members" : "Workspace Members"}
            {(selectedProjectId ? !projectMembersLoading : !membersLoading) && (
